...
class ChessGame:
    def __init__(self, root):
        ...
        self.bot_move_label = tk.Label(self.board_frame, text="Bot's Move: N/A", font=("Arial", 12))
    ...
    def bot_move(self):
        if not self.board.is_game_over() and not self.bot_thinking and self.board.turn == self.bot_color:
            ...
            self.bot_move_label.config(text="Bot's Move: N/A")  # Reset nhãn nước đi
        ...
        with self.lock:
            if move and self.bot_thinking:
                if move in self.board.legal_moves:
                    ...
                    self.bot_move_label.config(text=f"Bot's Move: {san_move}")  # Hiển thị nước đi của bot
    ...
    def reset_board(self):
        ...
        self.selected_square = None
        self.status_label.config(text="")
        self.bot_move_label.config(text="Bot's Move: N/A")
